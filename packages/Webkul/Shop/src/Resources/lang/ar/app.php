...
return [
    'customers' => [
        ...
        'login-form' => [
            ...
            'email-login' => 'تسجيل الدخول بالإيميل',
            'phone-number' => 'أدخل رقم هاتفك',
            'phone-help' => 'يرجى إدخال رقم الهاتف',
            'phone-login-title' => 'تسجيل الدخول بالهاتف',
            'no-account' => 'لا تملك حساب؟',
            'create-account' => 'إنشاء حساب',
            'phone-login-subtitle' => 'تسجيل الدخول باستخدام رقم الهاتف',
            'phone-placeholder' => '501234567',
            'send-otp' => 'إرسال رمز التحقق',
            'verify-otp' => 'تحقق من الرمز',
            'otp-sent' => 'تم إرسال رمز التحقق عبر WhatsApp',
            'otp-failed' => 'فشل في إرسال رمز التحقق',
            'invalid-otp' => 'رمز التحقق غير صحيح أو منتهي الصلاحية',
        ...
        'account' => [
            ...
            'wishlist' => [
                ...
                'moved-success'      => 'تم نقل العنصر بنجاح إلى السله',
    ...
    'checkout' => [
        ...
        'cart' => [
            ...
            'index' => [
                ...
                'select-cart-item'         => 'تحديد عنصر السله',
                'tax'                      => 'الضريبة',
                'total'                    => 'المجموع',
