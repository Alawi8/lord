                ...
                <div class="row">
                    <div class="col-12 header">
                        ...
                        <div class="invoice-text">
                            <span>{{ strtoupper(__('store::app.customers.account.orders.invoice-pdf.invoice')) }}</span>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-12">
                        <div class="col-6">
                            <div class="merchant-details">
                                <div class="row">
                                    <span class="label">
                                        @lang('store::app.customers.account.orders.invoice-pdf.invoice-id'): 
                                    </span>
                                ...
                                <div class="row">
                                    <span
                                        class="label">@lang('store::app.customers.account.orders.invoice-pdf.date'):
                                    </span>
                            ...
                            <div class="merchant-details">
                                @if (core()->getConfigData('sales.shipping.origin.contact'))
                                    <span class="merchant-details-title">
                                        @lang('store::app.customers.account.orders.invoice-pdf.contact-number'): 
                                    </span> 
                                ...
                                @if (core()->getConfigData('sales.shipping.origin.vat_number'))
                                    <span class="merchant-details-title">
                                        @lang('store::app.customers.account.orders.invoice-pdf.vat-number'): 
                        ...
                        <div class="col-6" style="padding-left: 80px">
                            <div class="row">
                                <span class="label">
                                    @lang('store::app.customers.account.orders.invoice-pdf.order-id'): 
                                </span>
                            ...
                            <div class="row">
                                <span class="label">
                                    @lang('store::app.customers.account.orders.invoice-pdf.order-date'): 
                                </span>
                            ...
                            @if ($invoice->hasPaymentTerm())
                                <div class="row">
                                    <span class="label">
                                        @lang('store::app.customers.account.orders.invoice-pdf.payment-terms') -
                                    </span>
                            ...
                            @if (core()->getConfigData('sales.shipping.origin.bank_details'))
                                <div class="row" style="padding-top: 20px">
                                    <span class="merchant-details-title">
                                        @lang('store::app.customers.account.orders.invoice-pdf.bank-details'):
                                    </span> 
            ...
            <div class="invoice-summary">
                <div class="table address">
                    <table>
                        <thead>
                            <tr>
                                <th class="table-header align-left" style="width: 50%;">{{ ucwords(trans('store::app.customers.account.orders.invoice-pdf.bill-to')) }}</th>
                                @if ($invoice->order->shipping_address)
                                    <th class="table-header align-left">{{ ucwords(trans('store::app.customers.account.orders.invoice-pdf.ship-to')) }}</th>
                                @endif
                            </tr>
                        </thead>
                            ...
                            <tr>
                                @if ($invoice->order->billing_address)
                                    <td>
                                        ...
                                        @lang('store::app.customers.account.orders.invoice-pdf.contact') : {{ $invoice->order->billing_address->phone }}
                                    </td>
                                @endif
                                ...
                                @if ($invoice->order->shipping_address)
                                    <td>
                                        ...
                                        @lang('store::app.customers.account.orders.invoice-pdf.contact') : {{ $invoice->order->shipping_address->phone }}
                                    </td>
                                @endif
                            </tr>
                        </tbody>
                        ...
                        <thead>
                            <tr>
                                <th class="table-header align-left" style="width: 50%;">
                                    @lang('store::app.customers.account.orders.invoice-pdf.payment-method')
                                </th>

                                @if ($invoice->order->shipping_address)
                                    <th class="table-header align-left">
                                        @lang('store::app.customers.account.orders.invoice-pdf.shipping-method')
                                    </th>
                                @endif
                            </tr>
                        </thead>
                            ...
                            <tr>
                                @foreach (['sku', 'product-name', 'price', 'qty', 'subtotal', 'tax-amount', 'grand-total'] as $item)
                                    <th class="text-center table-header">
                                        @lang('store::app.customers.account.orders.invoice-pdf.' . $item)
                                    </th>
                                @endforeach
                            </tr>
                        </thead>
                ...
                <table class="sale-summary">
                    <tr>
                        <td>
                            @lang('store::app.customers.account.orders.invoice-pdf.subtotal')
                        </td>
                    ...
                    <tr>
                        <td>
                            @lang('store::app.customers.account.orders.invoice-pdf.shipping-handling')
                        </td>
                    ...
                    @if ($invoice->base_discount_amount > 0)
                        <tr>
                            <td>
                                @lang('store::app.customers.account.orders.invoice-pdf.discount')
                            </td>
                    ...
                    <tr>
                        <td>
                            @lang('store::app.customers.account.orders.invoice-pdf.tax')
                        </td>
                    ...
                    <tr>
                        <td>
                            @lang('store::app.customers.account.orders.invoice-pdf.grand-total')
                        </td>
