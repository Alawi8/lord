@if (Webkul\Product\Helpers\ProductType::hasVariants($product->type))
    {!! view_render_event('bagisto.store.products.view.configurable-options.before', ['product' => $product]) !!}

    <v-product-configurable-options :errors="errors"></v-product-configurable-options>

    {!! view_render_event('bagisto.store.products.view.configurable-options.after', ['product' => $product]) !!}
                ...
                >
                    ...
                    <template v-else>
                        ...
                        <div class="flex items-center space-x-3">
                            ...
                            >
                                @lang('store::app.products.view.type.configurable.select-above-options')
                            </span>
                        </div>
                    </template>
            ...
            app.component('v-product-configurable-options', {
                ...
                methods: {
                    ...
                    fillSelect(attribute) {
                        ...
                        attribute.options = [{
                            'id': '',
                            'label': "@lang('store::app.products.view.type.configurable.select-options')",
                            'products': []
                        }];
