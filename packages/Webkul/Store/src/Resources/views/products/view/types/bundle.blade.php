@if ($product->type == 'bundle')
    {!! view_render_event('bagisto.store.products.view.bundle-options.before', ['product' => $product]) !!}

    <v-product-bundle-options :errors="errors"></v-product-bundle-options>

    {!! view_render_event('bagisto.store.products.view.bundle-options.after', ['product' => $product]) !!}
                ...
                <div>
                    ...
                    <div v-if="option.type == 'select'">
                        ...
                        >
                            ...
                            >
                                @lang('store::app.products.view.type.bundle.none')
                            </option>
            ...
            app.component('v-product-bundle-options', {
                ...
                computed: {
                    formattedTotalPrice: function() {
                        ...
                        return this.$store.formatPrice(total);
                    }
                },
