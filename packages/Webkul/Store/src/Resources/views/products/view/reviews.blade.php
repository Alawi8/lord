{!! view_render_event('bagisto.store.products.view.reviews.after', ['product' => $product]) !!}

<v-product-review :product-id="{{ $product->id }}">
    <div class="container max-1180:px-[20px]">
        <x-store::shimmer.products.reviews/>
    </div>
</v-product-review>
            ...
            >
                ...
                >
                    ...
                    >
                        <div class="max-w-[286px]">
                            <x-store::form.control-group>
                                <x-store::form.control-group.control
                                    ...
                                    rules="required"
                                    ref="reviewImages"
                                    :label="trans('store::app.products.view.reviews.attachments')"
                                    :is-multiple="true"
                                >
                                </x-store::form.control-group.control>
                        ...
                        <div>
                            <x-store::form.control-group>
                                <x-store::form.control-group.label class="mt-[0] required">
                                    @lang('store::app.products.view.reviews.rating')
                                ...
                                <x-store::products.star-rating
                                    ...
                                    :disabled="false"
                                    rules="required"
                                    :label="trans('store::app.products.view.reviews.rating')"
                                >
                                </x-store::products.star-rating>
                            ...
                            @if (
                                ...
                                <x-store::form.control-group>
                                    <x-store::form.control-group.label class="required">
                                        @lang('store::app.products.view.reviews.name')
                                    </x-store::form.control-group.label>
                                    ...
                                    <x-store::form.control-group.control
                                        ...
                                        :value="old('name')"
                                        rules="required"
                                        :label="trans('store::app.products.view.reviews.name')"
                                        :placeholder="trans('store::app.products.view.reviews.name')"
                                    >
                                    </x-store::form.control-group.control>
                            ...
                            <x-store::form.control-group>
                                <x-store::form.control-group.label class="required">
                                    @lang('store::app.products.view.reviews.title')
                                </x-store::form.control-group.label>
                                ...
                                <x-store::form.control-group.control
                                    ...
                                    :value="old('title')"
                                    rules="required"
                                    :label="trans('store::app.products.view.reviews.title')"
                                    :placeholder="trans('store::app.products.view.reviews.title')"
                                >
                                </x-store::form.control-group.control>
                            ...
                            <x-store::form.control-group>
                                <x-store::form.control-group.label class="required">
                                    @lang('store::app.products.view.reviews.comment')
                                </x-store::form.control-group.label>
                                ...
                                <x-store::form.control-group.control
                                    ...
                                    :value="old('comment')"
                                    rules="required"
                                    :label="trans('store::app.products.view.reviews.comment')"
                                    :placeholder="trans('store::app.products.view.reviews.comment')"
                                >
                                </x-store::form.control-group.control>
                            ...
                            <div class="flex gap-[15px] justify-start max-sm:flex-wrap mt-4 max-sm:justify-center max-sm:mb-[20px] max-xl:mb-[20px]">
                                <button
                                    ...
                                    type='submit'
                                >
                                    @lang('store::app.products.view.reviews.submit-review')
                                </button>
                                ...
                                >
                                    @lang('store::app.products.view.reviews.cancel')
                                </button>
                            </div>
                        </div>
                    </form>
                ...
                <template v-else>
                    ...
                    <div class="flex gap-[15px] items-center justify-between  max-sm:flex-wrap">
                        <h3 class="font-dmserif text-[30px] max-sm:text-[22px]">
                            @lang('store::app.products.view.reviews.customer-review')
                        </h3>
                        ...
                        @if (
                            ...
                            >
                                ...
                                @lang('store::app.products.view.reviews.write-a-review')
                            </div>
                        @endif
                    </div>
                    ...
                    <template v-if="reviews.length">
                        ...
                        <div class="flex gap-[15px] justify-between items-center max-w-[365px] mt-[30px] max-sm:flex-wrap">
                            ...
                            <x-store::products.star-rating :value="$avgRatings"></x-store::products.star-rating>

                            <p class="text-[12px] text-[#858585]">
                                (@{{ meta.total }} @lang('store::app.products.view.reviews.customer-review'))
                            </p>
                        </div>
                        ...
                        <button
                            ...
                            @click="get()"
                        >
                            @lang('store::app.products.view.reviews.load-more')
                        </button>
                    </template>
                    ...
                    <template v-else>
                        ...
                        <div class="grid items-center justify-items-center w-[100%] m-auto h-[476px] place-content-center text-center">
                            ...
                            <p class="text-[20px]">
                                @lang('store::app.products.view.reviews.empty-review')
                            </p>
                        </div>
                    </template>
                </template>
        ...
        app.component('v-product-review', {
            ...
            data() {
                return {
                    ...
                    links: {
                        next: '{{ route('store.api.products.reviews.index', $product->id) }}',
                    },
            ...
            methods: {
                ...
                store(params, { resetForm, setErrors }) {
                    this.$axios.post('{{ route('store.api.products.reviews.store', $product->id) }}', params, {
                            headers: {
                        ...
                        .catch(error => {
                            setErrors({'attachments': ["@lang('store::app.products.view.reviews.failed-to-upload')"]});
