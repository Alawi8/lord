{!! view_render_event('bagisto.store.checkout.shipping.method.before') !!}
...
{!! view_render_event('bagisto.store.checkout.shipping.method.after') !!}
                    ...
                    <x-slot:header>
                        <div class="flex justify-between items-center">
                            <h2 class="text-[26px] font-medium max-sm:text-[20px]">
                                @lang('store::app.checkout.onepage.shipping.shipping-method')
                            </h2>
                        </div>
                    </x-slot:header>
        ...
        app.component('v-shipping-method', {
            ...
            methods: {
                store(selectedShippingMethod) {
                    ...
                    this.$axios.post("{{ route('store.checkout.onepage.shipping_methods.store') }}", {    
