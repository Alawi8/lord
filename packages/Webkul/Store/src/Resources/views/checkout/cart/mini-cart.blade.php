            ...
            <x-slot:header>
                <div class="flex justify-between items-center">
                    <p class="text-[26px] font-medium">
                        @lang('store::app.checkout.cart.mini-cart.storeping-cart')
                    </p>
                </div>

                <p class="text-[16px]">
                    @lang('store::app.checkout.cart.mini-cart.offer-on-orders')
                </p>
            </x-slot:header>
            ...
            <x-slot:content>
                        ...
                        <div class="grid flex-1 gap-y-[10px] place-content-start justify-stretch">
                            ...
                            >
                                ...
                                <div class="">
                                    ...
                                    >
                                        @lang('store::app.checkout.cart.mini-cart.see-details')
                            ...
                            <div class="flex gap-[20px] items-center flex-wrap">
                                ...
                                >
                                    @lang('store::app.checkout.cart.mini-cart.remove')
                                </button>
                            </div>
                        </div>
                    </div>
                ...
                >
                    <div class="grid gap-y-[20px] b-0 place-items-center">
                        ...
                        <p class="text-[20px]">
                            @lang('store::app.checkout.cart.mini-cart.empty-cart')
                        </p>
                    </div>
                </div>
            </x-slot:content>
                ...
                <div v-if="cart?.items?.length">
                    <div class="flex justify-between items-center mt-[60px] mb-[30px] px-[25px] pb-[8px] border-b-[1px] border-[#E9E9E9]">
                        <p class="text-[14px] font-medium text-[#6E6E6E]">
                            @lang('store::app.checkout.cart.mini-cart.subtotal')
                        </p>
                    ...
                    <div class="px-[25px]">
                        <a
                            href="{{ route('store.checkout.onepage.index') }}"
                        ...
                        >
                            @lang('store::app.checkout.cart.mini-cart.continue-to-checkout')
                        </a>
                        ...
                        <div class="block m-0 ml-[0px] py-[15px] text-base text-center font-medium cursor-pointer">
                            <a href="{{ route('store.checkout.cart.index') }}">
                                @lang('store::app.checkout.cart.mini-cart.view-cart')
                            </a>
                        </div>
                    </div>
                </div>
        ...
        app.component("v-mini-cart", {
           ...
           methods: {
                ...
                updateItem(quantity, item) {
                    ...
                    this.$axios.put('{{ route('store.api.checkout.cart.update') }}', { qty })
                        .then(response => {
