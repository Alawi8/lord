    ...
    <script type="text/x-template" id="v-coupon-template">
        <div class="flex justify-between text-right">
            <p class="text-[16px] max-sm:text-[14px] max-sm:font-normal">
                @{{ isCouponApplied ? "@lang('store::app.checkout.cart.coupon.applied')" : "@lang('store::app.checkout.cart.coupon.discount')" }}
            </p>
            ...
            <p class="text-[16px] font-medium max-sm:text-[14px]">
                ...
                <x-store::modal ref="couponModel">
                    ...
                    <x-slot:toggle>
                        ...
                        >
                            @lang('store::app.checkout.cart.coupon.apply')
                        </span>
                    </x-slot:toggle>
                                ...
                                <x-store::form.control-group>
                                    <div class="p-[30px] bg-white">
                                        <x-store::form.control-group.control
                                            ...
                                            rules="required"
                                            :placeholder="trans('store::app.checkout.cart.coupon.enter-your-code')"
                                            v-model="code"
                                        >
                                        </x-store::form.control-group.control>
                                ...
                                <div class="p-[30px] bg-white mt-[20px]">
                                    <div class="flex justify-between items-center gap-[15px] flex-wrap">
                                        <p class="text-[14px] font-medium text-[#6E6E6E]">
                                            @lang('store::app.checkout.cart.coupon.subtotal')
                                        </p>
                                        ...
                                        <div class="flex gap-[30px] items-center flex-auto flex-wrap">
                                            ...
                                            <button
                                                ...
                                                type="submit"
                                            >
                                               @lang('store::app.checkout.cart.coupon.button-title')
                                            </button>
                                        </div>
                                    </div>
                                </div>
                ...
                >
                    <p 
                        ...
                        title="@lang('store::app.checkout.cart.coupon.applied')"
                    >
                        "@{{ isCouponApplied }}"
                    </p>
                    ...
                    <span 
                        ...
                        title="@lang('store::app.checkout.cart.coupon.remove')"
                        @click="destroyCoupon"
                    >
                    </span>
                </div>
