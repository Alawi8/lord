<div class="w-[418px] max-w-full">
    <p class="text-[26px] font-medium">
        @lang('store::app.checkout.cart.summary.cart-summary')
    </p>

    <div class="grid gap-[15px] mt-[25px]">
        <div class="flex justify-between text-right">
            <p class="text-[16px]">
                @lang('store::app.checkout.cart.summary.sub-total')
            </p>
        ...
        >
            <p class="text-[16px] max-sm:text-[14px] max-sm:font-normal">
                @lang('store::app.checkout.cart.summary.tax') (@{{ index }})%
            </p>
        ...
        >
            <p class="text-[16px]">
                @lang('store::app.checkout.cart.summary.discount-amount')
            </p>
        ...
        @include('store::checkout.cart.coupon')
   
        <div class="flex justify-between text-right">
            <p class="text-[18px] font-semibold">
                @lang('store::app.checkout.cart.summary.grand-total')
            </p>
        ...
        >
            @lang('store::app.checkout.cart.summary.proceed-to-checkout')
        </a>
    </div>
</div>