@component('store::emails.layout')
    <div style="margin-bottom: 34px;">
        ...
        <p style="font-size: 16px;color: #384860;line-height: 24px;">
            @lang('store::app.emails.customers.registration.greeting')
        </p>
    </div>

    <p style="font-size: 16px;color: #384860;line-height: 24px;margin-bottom: 40px">
        @lang('store::app.emails.customers.registration.description')
    </p>
    ...
    <div style="display: flex;margin-bottom: 95px">
        ...
        >
            @lang('store::app.emails.customers.registration.sign-in')
        </a>
    </div>
@endcomponent