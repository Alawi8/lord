@component('store::emails.layout')
    <div style="margin-bottom: 34px;">
        ...
        <p style="font-size: 16px;color: #5E5E5E;line-height: 24px;">
            @lang('store::app.emails.orders.shipped.greeting', [
                'invoice_id' => $shipment->increment_id,
                'order_id'   => '<a href="' . route('store.customers.account.orders.view', $shipment->order_id) . '" style="color: #2969FF;">#' . $shipment->order->increment_id . '</a>',
            ...
            <div style="line-height: 25px;">
                ...
                @if (! empty($additionalDetails))
                    <div style="font-size: 16px; color: #384860;">
                        <div>
                            <span>
                                @lang('store::app.emails.orders.carrier') : 
                            </span>
