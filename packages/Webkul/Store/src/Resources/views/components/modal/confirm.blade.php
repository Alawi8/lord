...
@pushOnce('scripts')
    ...
    <script type="module">
        app.component('v-modal-confirm', {
            ...
            methods: {
                open({
                    title = "@lang('store::app.components.modal.confirm.title')",
                    message = "@lang('store::app.components.modal.confirm.message')",
                    options = {
                        btnDisagree: "@lang('store::app.components.modal.confirm.disagree-btn')",
                        btnAgree: "@lang('store::app.components.modal.confirm.agree-btn')",
                    },
                    agree = () => {},
                    disagree = () => {},
                }) {
