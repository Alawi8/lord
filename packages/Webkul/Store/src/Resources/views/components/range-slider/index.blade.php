    ...
    <script type="text/x-template" id="v-range-slider-template">
        <div>
            <div class="flex items-center gap-[15px]">
                <p class="text-[14px]">
                    @lang('store::app.components.range-slider.range')
                </p>
                     ...
                     */
                     if (this.isTypeSupported()) {
                        switch (this.defaultType) {
                            case 'price':
                                return {
                                    formattedAllowedMinRange: this.$store.formatPrice(this.allowedMinRange),
                                    formattedAllowedMaxRange: this.$store.formatPrice(this.allowedMaxRange),
                                    formattedMinRange: this.$store.formatPrice(this.minRange),
                                    formattedMaxRange: this.$store.formatPrice(this.maxRange),
                                };
