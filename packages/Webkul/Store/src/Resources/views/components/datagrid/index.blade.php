...
<v-datagrid {{ $attributes }}>
    <x-store::shimmer.datagrid :isMultiRow="$isMultiRow"></x-store::shimmer.datagrid>
...
@pushOnce('scripts')
    ...
    >
        <div>
            <x-store::datagrid.toolbar></x-store::datagrid.toolbar>

            <div class="flex mt-[30px]">
                <x-store::datagrid.table :isMultiRow="$isMultiRow">
                    <template #header>
                        <slot
                            name="header"
