...
>
    <x-store::shimmer.products.carousel :navigation-link="$navigationLink ?? false"></x-store::shimmer.products.carousel>
</v-products-carousel>
    ...
    <script type="text/x-template" id="v-products-carousel-template">
        <div class="container mt-20 max-lg:px-[30px] max-sm:mt-[30px]" v-if="! isLoading && products.length">
            ...
            <a
                ...
                v-if="navigationLink"
            >
                @lang('store::app.components.products.carousel.view-all')
            </a>
        </div>
