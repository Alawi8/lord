...
--}}
@php
    $showCompare = (bool) core()->getConfigData('general.content.store.compare_option');

    $showWishlist = (bool) core()->getConfigData('general.content.store.wishlist_option');
@endphp
...
<div class="gap-[15px] flex-wrap px-[15px] pt-[25px] hidden max-lg:flex max-lg:mb-[15px]">
            ...
            >
                ...
                <x-slot:content>
                    ...
                    <div class="absolute w-full flex bottom-0 left-0 bg-white shadow-lg p-4 gap-x-[20px] justify-between items-center mb-[15px]">
                        <x-store::dropdown position="top-left">
                            <!-- Dropdown Toggler -->
                            <x-slot:toggle>
                        ...
                        <x-store::dropdown position="top-right">
                            <x-slot:toggle>
                                {{-- Dropdown Toggler --}}
                                <div class="w-full flex gap-[10px] justify-between items-center cursor-pointer">
                                    <img
    ...
    {{-- Serach Catalog Form --}}
    <form action="{{ route('store.search.index') }}" class="flex items-center w-full">
