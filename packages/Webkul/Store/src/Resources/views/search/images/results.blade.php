<v-image-search-result-component>
    <div class="mt-[30px] p-[20px] border border-gray-200 rounded-lg">
        <div class="flex gap-[46px]">
            <x-store::media.images.lazy class="max-w-[110px] max-h-[110px] min-w-[110px] w-[110px] h-[110px] rounded-sm"></x-store::media.images.lazy>
            ...
            <div class="flex gap-[46px]">
                ...
                <div class="flex flex-col gap-[15px]">
                    <h2 class="text-[26px] font-medium">
                        @lang('store::app.search.images.results.analysed-keywords')
                    </h2>
