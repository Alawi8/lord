...
return [
    'customers' => [
        ...
        'account' => [
            ...
            'profile'   => [
                ...
                'delete-failed'           => 'Erreur lors de la suppression du client.',
                'delete'                  => 'Supprimer',
                'email'                   => 'E-mail',
                ...
                'other'                   => 'Autre',
                'order-pending'           => 'Impossible de supprimer le compte client car certaines commandes sont en attente ou en traitement.',
                'phone'                   => 'Téléphone',
                'save'                    => 'Enregistrer',
                'subscribe-to-newsletter' => 'Souscrire à la newsletter',
                'title'                   => 'Profil',
            ...
            'addresses' => [
                ...
                'save'             => 'Enregistrer',
                'security-warning' => 'Activité suspecte trouvée !!!',
                'title'            => 'Adresse',
            ...
            'orders' => [
                ...
                'view' => [
                    ...
                    'shipments' => [
                        'individual-shipment' => 'Expédition n°: shipment_id',
                        'product-name'        => 'Nom',
                        'qty'                 => 'Qté',
                        'sku'                 => 'SKU',
    ...
    'components' => [
        ...
        'layouts' => [
            ...
            'footer' => [
                ...
                'currency'               => 'Devise',
                'footer-text'            => '© Droits d\'auteur 2010 - 2023, Webkul Software (enregistré en Inde). Tous droits réservés.',
                'locale'                 => 'Langue',
        ...
        'products'   => [
            'card' => [
                ...
                'new'                => 'Nouveau',
                'review-description' => 'Soyez le premier à donner votre avis sur ce produit',
                'sale'               => 'En soldes',
            ],
    ...
    'checkout' => [
        ...
        'cart' => [
            ...
            'missing-links'             => 'Les liens de téléchargement sont manquants pour ce produit.',
            ...
            'index' => [
                'cart'                     => 'Panier',
                'continue-storeping'        => 'Continuer vos achats',
        ...
        'onepage' => [
            'addresses' => [
                'billing' => [
                    ...
                    'same-billing-address' => 'L\'adresse est la même que celle de ma facturation',
                    'street-address'       => 'Adresse',
                    'state'                => 'État',
                    'select-state'         => 'Sélectionner l\'État',
                    'save-address'         => 'Enregistrer cette adresse',
                    'telephone'            => 'Téléphone',
                ],
