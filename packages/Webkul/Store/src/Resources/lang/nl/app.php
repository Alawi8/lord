...
return [
    ...
    'checkout' => [
        ...
        'cart' => [
            ...
            'return-to-store'            => 'Terug naar de winkel',
            ...
            'index' => [
                'cart'                     => 'Winkelwagen',
                'continue-storeping'        => 'Doorgaan met winkelen',
            ...
            'summary' => [
                ...
                'delivery-charges'    => 'Leveringskosten',
        ...
        'onepage' => [
            'addresses' => [
                'billing' => [
                    ...
                    'last-name'            => 'Achternaam',
                    'postcode'             => 'Postcode',
                    'same-billing-address' => 'Adres is hetzelfde als mijn factuuradres',
                    'street-address'       => 'Straatnaam en huisnummer',
                    'state'                => 'Provincie',
