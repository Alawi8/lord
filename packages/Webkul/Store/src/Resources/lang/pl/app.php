...
return [
            ...
            'orders' => [
                ...
                'view' => [
                    ...
                    'information' => [
                        ...
                        'item-ordered'      => 'Zamówione (sztuk: :qty_ordered)',
                        'item-invoice'      => 'Faktura (sztuk: :qty_invoiced)',
                        'item-shipped'      => 'Wysłane (sztuk: :qty_shipped)',
                        'item-canceled'     => 'Anulowane (sztuk: :qty_canceled)',
                        'item-refunded'     => 'Zwrot (sztuk: :qty_refunded)',
                        'placed-on'         => 'Zamówienie złożone dnia',
                        ...
                        'total-refunded'    => 'Suma zwrócona',
                        'total-due'         => 'Należność ogółem',
                    ],
    ...
    'checkout' => [
        ...
        'cart' => [
            ...
            'return-to-store'            => 'Wróć do sklepu',
            ...
            'index' => [
                'cart'                     => 'Koszyk',
                'continue-storeping'        => 'Kontynuuj zakupy',
    ...
    'emails' => [
        ...
        'orders' => [
            ...
            'sku'               => 'SKU',
            'subtotal'          => 'Suma częściowa',
            'shipping-handling' => 'Opłaty za przesyłkę',
            'tracking-number'   => 'Numer przesyłki: :tracking_number',
            'tax'               => 'Podatek',
        ],
    ],
];
