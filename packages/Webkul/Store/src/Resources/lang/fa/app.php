...
return [
    ...
    'checkout' => [
        ...
        'cart' => [
            ...
            'return-to-store'            => 'بازگشت به فروشگاه',
        ...
        'onepage' => [
            'addresses' => [
                'billing' => [
                    ...
                    'last-name'            => 'نام خانوادگی',
                    'postcode'             => 'کد پستی',
                    'same-billing-address' => 'آدرس مشابه آدرس صورتحساب من است',
                    'street-address'       => 'آدرس',
                    'state'                => 'استان',
            ...
            'coupon' => [
                'applied'         => 'کد تخفیف اعمال شد',
                'applied-coupon'  => 'کد تخفیف اعمال شده',
                'apply'           => 'اعمال کد تخفیف',
                'apply-issue'     => 'نمی‌توان کد تخفیف را اعمال کرد.',
                'button-title'    => 'اعمال',
                'code'            => 'کد تخفیف',
