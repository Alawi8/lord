...
return [
    'customers' => [
        ...
        'account' => [
            ...
            'profile' => [
                ...
                'delete-failed'           => '顧客を削除する際にエラーが発生しました。',
                'delete'                  => '削除',
                'email'                   => 'メール',
                ...
                'other'                   => 'その他',
                'order-pending'           => '注文が保留中または処理中のため、顧客アカウントを削除できません。',
                'phone'                   => '電話',
                'save'                    => '保存',
                'subscribe-to-newsletter' => 'ニュースレターに登録',
                'title'                   => 'プロフィール',
            ...
            'addresses' => [
                ...
                'street-address'   => '住所',
                'save'             => '保存',
                'security-warning' => '不正なアクティビティが検出されました！',
                'title'            => '住所',
                'vat-id'           => 'VAT ID',
            ],
            ...
            'orders' => [
                ...
                'view' => [
                    ...
                    'shipments' => [
                        'individual-shipment' => '発送 #:shipment_id',
                        'product-name'        => '商品名',
                        'qty'                 => '数量',
                        'sku'                 => 'SKU',
                        'shipments'           => '発送',
    ...
    'components' => [
        ...
        'products' => [
            'card' => [
                ...
                'add-to-cart'        => 'カートに追加',
                'new'                => '新着',
                'review-description' => 'この商品の最初のレビュアーになる',
                'sale'               => 'セール',
            ],
        ...
        'onepage' => [
            'addresses' => [
                'billing' => [
                    ...
                    'last-name'            => '姓',
                    'postcode'             => '郵便番号',
                    'same-billing-address' => '住所は請求先住所と同じです',
                    'street-address'       => '住所',
                    'state'                => '都道府県',
    ...
    'emails' => [
        ...
        'orders' => [
            ...
            'sku'               => 'SKU',
            'subtotal'          => '小計',
            'shipping-handling' => '配送と取扱',
            'tracking-number'   => 'トラッキング番号 : :tracking_number',
            'tax'               => '税金',
        ],
    ],
];
