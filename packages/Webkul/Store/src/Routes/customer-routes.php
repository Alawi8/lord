        ...
        Route::group(['middleware' => ['customer']], function () {
            ...
            Route::prefix('account')->group(function () {
                ...
                Route::controller(OrderController::class)->prefix('orders')->group(function () {
                    Route::get('', 'index')->name('store.customers.account.orders.index');

                    Route::get('view/{id}', 'view')->name('store.customers.account.orders.view');

                    Route::post('cancel/{id}', 'cancel')->name('store.customers.account.orders.cancel');

                    Route::get('print/Invoice/{id}', 'printInvoice')->name('store.customers.account.orders.print-invoice');
                });
