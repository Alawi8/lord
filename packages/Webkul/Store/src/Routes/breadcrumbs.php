...
Breadcrumbs::for('store.customer.profile.index', function (BreadcrumbTrail $trail) {
    $trail->push(trans('store::app.customer.account.profile.index.title'), route('store.customer.profile.index'));
});
...
Breadcrumbs::for('store.customer.orders.index', function (BreadcrumbTrail $trail) {
    ...
    $trail->push(trans('store::app.customer.account.order.index.page-title'), route('store.customer.orders.index'));
});
...
Breadcrumbs::for('store.customer.downloadable_products.index', function (BreadcrumbTrail $trail) {
    ...
    $trail->push(trans('store::app.customer.account.downloadable_products.title'), route('store.customer.downloadable_products.index'));
});
...
Breadcrumbs::for('store.customer.wishlist.index', function (BreadcrumbTrail $trail) {
    ...
    $trail->push(trans('store::app.customer.account.wishlist.page-title'), route('store.customer.wishlist.index'));
});
...
Breadcrumbs::for('store.customer.reviews.index', function (BreadcrumbTrail $trail) {
    ...
    $trail->push(trans('store::app.customer.account.review.index.page-title'), route('store.customer.reviews.index'));
});
...
Breadcrumbs::for('store.customer.addresses.index', function (BreadcrumbTrail $trail) {
    ...
    $trail->push(trans('store::app.customer.account.address.index.page-title'), route('store.customer.addresses.index'));
});
...
Breadcrumbs::for('store.customer.addresses.create', function (BreadcrumbTrail $trail) {
    ...
    $trail->push(trans('store::app.customer.account.address.create.page-title'), route('store.customer.addresses.create'));
});

Breadcrumbs::for('store.customer.addresses.edit', function (BreadcrumbTrail $trail, $id) {
    $trail->parent('store.customer.addresses.index');

    $trail->push(trans('store::app.customer.account.address.edit.page-title'), route('store.customer.addresses.edit', $id));
});
