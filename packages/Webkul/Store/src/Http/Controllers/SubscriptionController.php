...
class SubscriptionController extends Controller
{
    ...
    public function store()
    {
        ...
        if ($subscription) {
            session()->flash('error', trans('store::app.subscription.already'));
        ...
        session()->flash('success', trans('store::app.subscription.subscribe-success'));
    ...
    public function destroy($token)
    {
        ...
        session()->flash('success', trans('store::app.subscription.unsubscribe-success'));
