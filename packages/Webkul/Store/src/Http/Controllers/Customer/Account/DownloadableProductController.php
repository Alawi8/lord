...
class DownloadableProductController extends Controller
{
    ...
    */
    public function index()
    {
        ...
        return view('store::customers.account.downloadable_products.index')->with('downloadableLinkPurchased', $downloadableLinkPurchased);
    }
    ...
    public function download($id)
    {
        ...
        if (
            ...
            session()->flash('warning', trans('store::app.customers.account.downloadable_products.payment-error'));

            return redirect()->route('store.customer.downloadable_products.index');
        }
        ...
        if (
            ...
            session()->flash('warning', trans('store::app.customers.account.downloadable-products.download-error'));
