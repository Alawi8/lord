...
use Webkul\Store\Http\Requests\Customer\RegistrationRequest;
...
class RegistrationController extends Controller
{
    ...
    {
        return view('store::customers.sign-up');
    }
    ...
    public function store(RegistrationRequest $registrationRequest)
    {
        ...
        if (core()->getConfigData('customer.settings.email.verification')) {
            session()->flash('success', trans('store::app.customers.signup-form.success-verify'));
        } else {
            session()->flash('success', trans('store::app.customers.signup-form.success'));
        }
    ...
    public function verifyAccount($token)
    {
        ...
        if ($customer) {
            ...
            session()->flash('success', trans('store::app.customers.signup-form.verified'));
        } else {
            session()->flash('warning', trans('store::app.customers.signup-form.verify-failed'));
        }
    ...
    public function resendVerificationEmail($email)
    {
        ...
        try {
            ...
            session()->flash('error', trans('store::app.customers.signup-form.verification-not-sent'));

            return redirect()->back();
        }

        session()->flash('success', trans('store::app.customers.signup-form.verification-sent'));
