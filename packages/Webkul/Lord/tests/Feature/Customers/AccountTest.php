...
use Webkul\Lord\Mail\Customer\ResetPasswordNotification;
use Webkul\Lord\Mail\Customer\UpdatePasswordNotification;
...
it('should returns the profile page', function () {
    ...
    get(route('lord.customers.account.profile.index'))
        ->assertOk()
        ->assertSeeText(trans('lord::app.customers.account.profile.index.edit'))
        ->assertSeeText(trans('lord::app.customers.account.profile.index.delete'))
...
it('should returns the edit page of the customer', function () {
    ...
    get(route('lord.customers.account.profile.edit'))
        ->assertOk()
        ->assertSeeText($customer->email)
        ->assertSeeText($customer->first_name)
        ->assertSeeText(trans('lord::app.customers.account.profile.edit.edit-profile'));
});
...
it('should fails the validations error when certain inputs are not provided when update the customer', function () {
    ...
    postJson(route('lord.customers.account.profile.update'), [
...
it('should update the customer', function () {
    ...
    postJson(route('lord.customers.account.profile.update'), [
        ...
        ->assertRedirect(route('lord.customers.account.profile.index'));
...
it('should fails the validation error when password is not provided when delete the customer account', function () {
    ...
    postJson(route('lord.customers.account.profile.destroy'))
...
it('should delete the customer account', function () {
    ...
    postJson(route('lord.customers.account.profile.destroy'), [
        ...
        ->assertRedirect(route('lord.customer.session.index'));
...
it('should shows the reviews of customer', function () {
    ...
    get(route('lord.customers.account.reviews.index'))
        ->assertOk()
        ->assertSeeText(trans('lord::app.customers.account.reviews.title'))
...
it('should returns the address page of the customer', function () {
    ...
    get(route('lord.customers.account.addresses.index'))
        ->assertOk()
        ...
        ->assertSeeText(trans('lord::app.customers.account.addresses.index.add-address'));
});
...
it('should returns the create page of address', function () {
    ...
    get(route('lord.customers.account.addresses.create'))
        ->assertOk()
        ->assertSeeText(trans('lord::app.customers.account.addresses.index.add-address'))
        ->assertSeeText(trans('lord::app.customers.account.addresses.create.first-name'))
        ->assertSeeText(trans('lord::app.customers.account.addresses.create.last-name'))
        ->assertSeeText(trans('lord::app.customers.account.addresses.create.vat-id'))
        ->assertSeeText(trans('lord::app.customers.account.addresses.create.street-address'))
        ->assertSeeText(trans('lord::app.customers.account.addresses.create.company-name'));
});
...
it('should fails the validation error when certain inputs not provided when store the customer address', function () {
    ...
    postJson(route('lord.customers.account.addresses.store'))
...
it('should store the customer address', function () {
    ...
    postJson(route('lord.customers.account.addresses.store'), [
        ...
        ->assertRedirect(route('lord.customers.account.addresses.index'));
...
it('should edit the customer address', function () {
    ...
    get(route('lord.customers.account.addresses.edit', $customerAddress->id))
        ->assertOk()
        ->assertSeeText(trans('lord::app.customers.account.addresses.edit.edit'))
        ->assertSeeText(trans('lord::app.customers.account.addresses.edit.title'))
        ->assertSeeText(trans('lord::app.customers.account.addresses.edit.update-btn'));
});
...
it('should fails the validation error when certain inputs not provided update the customer address', function () {
    ...
    putJson(route('lord.customers.account.addresses.update', $customerAddress->id))
        ->assertJsonValidationErrorFor('city')
        ->assertJsonValidationErrorFor('phone')
        ->assertJsonValidationErrorFor('state')
        ->assertJsonValidationErrorFor('country')
...
it('should set default address for the customer', function () {
    ...
    patchJson(route('lord.customers.account.addresses.update.default', $customerAddresses->id))
        ->assertRedirect();
...
it('should delete the customer address', function () {
    ...
    deleteJson(route('lord.customers.account.addresses.delete', $customerAddress->id))
        ->assertRedirect();
...
it('should send email for password reset', function () {
    ...
    postJson(route('lord.customers.forgot_password.store'), [
        'email' => $customer->email,
    ])
        ->assertRedirect(route('lord.customers.forgot_password.create'))
        ->isRedirect();
