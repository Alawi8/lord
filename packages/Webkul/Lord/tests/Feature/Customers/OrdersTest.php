...
it('should returns the index page customers orders', function () {
    ...
    get(route('lord.customers.account.orders.index'))
        ->assertOk()
        ->assertSeeText(trans('lord::app.customers.account.orders.title'));
});
...
it('should view the order', function () {
    ...
    get(route('lord.customers.account.orders.view', $order->id))
        ->assertOk()
        ->assertSeeText(trans('lord::app.customers.account.orders.view.information.sku'))
        ->assertSeeText(trans('lord::app.customers.account.orders.view.information.product-name'))
        ->assertSeeText(trans('lord::app.customers.account.orders.view.information.total-due'))
        ->assertSeeText(trans('lord::app.customers.account.orders.view.page-title', ['order_id' => $order->increment_id]));
...
it('should cancel the customer order', function () {
    ...
    postJson(route('lord.customers.account.orders.cancel', $order->id))
        ->assertRedirect();
...
it('should print the order invoice', function () {
    ...
    getJson(route('lord.customers.account.orders.print-invoice', $invoice->id))
