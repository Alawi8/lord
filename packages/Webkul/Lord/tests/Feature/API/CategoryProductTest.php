...
it('returns paginated category products', function () {
    ...
    $availableLimits->each(function ($limit) use ($specifiedCategory, $productsCount) {
        getJson(route('lord.api.products.index', ['category_id' => $specifiedCategory->id, 'limit' => $limit]))
            ->assertOk()
...
it('returns category products sorted by name descending', function () {
    ...
    // Act and Assert.
    getJson(route('lord.api.products.index', ['category_id' => $specifiedCategory->id, 'sort' => 'name-desc']))
        ->assertOk()
...
it('returns category products sorted by name ascending', function () {
    ...
    // Act and Assert.
    getJson(route('lord.api.products.index', ['category_id' => $specifiedCategory->id, 'sort' => 'name-asc']))
        ->assertOk()
...
it('returns category products sorted by created_at descending', function () {
    ...
    // Act and Assert.
    getJson(route('lord.api.products.index', ['category_id' => $specifiedCategory->id, 'sort' => 'created_at-desc']))
        ->assertOk()
...
it('returns category products sorted by created_at ascending', function () {
    ...
    // Act and Assert.
    getJson(route('lord.api.products.index', ['category_id' => $specifiedCategory->id, 'sort' => 'created_at-asc']))
        ->assertOk()
        ->assertSeeTextInOrder([
            $firstProduct->id,
            $secondProduct->id,
...
it('returns category products sorted by price descending', function () {
    ...
    // Act and Assert.
    getJson(route('lord.api.products.index', ['category_id' => $specifiedCategory->id, 'sort' => 'price-desc']))
        ->assertOk()
...
it('returns category products sorted by price ascending', function () {
    ...
    // Act and Assert.
    getJson(route('lord.api.products.index', ['category_id' => $specifiedCategory->id, 'sort' => 'price-asc']))
        ->assertOk()
