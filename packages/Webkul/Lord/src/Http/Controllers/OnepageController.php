...
class OnepageController extends Controller
{
    ...
    public function index()
    {
        ...
        if (
            ...
            && ! core()->getConfigData('sales.checkout.lordping_cart.allow_guest_checkout')
        ) {
        ...
        if (auth()->guard('customer')->user()?->is_suspended) {
            session()->flash('warning', trans('lord::app.checkout.cart.suspended-account-message'));
        ...
        return view('lord::checkout.onepage.index', compact('cart'));
    }
    ...
    public function success(OrderRepository $orderRepository)
    {
        ...
        return view('lord::checkout.success', compact('order'));
    }
