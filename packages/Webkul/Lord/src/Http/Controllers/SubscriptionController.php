...
class SubscriptionController extends Controller
{
    ...
    public function store()
    {
        ...
        if ($subscription) {
            session()->flash('error', trans('lord::app.subscription.already'));
        ...
        session()->flash('success', trans('lord::app.subscription.subscribe-success'));
    ...
    public function destroy($token)
    {
        ...
        session()->flash('success', trans('lord::app.subscription.unsubscribe-success'));
