...
use Webkul\Lord\DataGrids\GDPRRequestsDatagrid;
...
class GDPRController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('lord::customers.account.gdpr.index');
    }
    ...
    public function store()
    {
        ...
        session()->flash('success', trans('lord::app.customers.account.gdpr.create-success'));

        return redirect()->route('lord.customers.account.gdpr.index');
    }
    ...
    public function pdfView()
    {
        ...
        $pdf = \PDF::loadView('lord::customers.account.gdpr.pdf', compact('param'));
    ...
    public function htmlView()
    {
        ...
        return view('lord::customers.account.gdpr.pdf', compact('param'));
    }
    ...
    {
        return view('lord::components.layouts.cookie.consent');
    }
    ...
    public function revoke($id)
    {
        ...
        if (! $data) {
            session()->flash('error', trans('lord::app.customers.account.gdpr.revoke-failed'));
        ...
        session()->flash('success', trans('lord::app.customers.account.gdpr.revoked-successfully'));
