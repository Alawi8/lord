...
use Webkul\Lord\DataGrids\DownloadableProductDataGrid;
...
class DownloadableProductController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('lord::customers.account.downloadable_products.index');
    }
    ...
    public function download($id)
    {
        ...
        if (
            ...
            session()->flash('warning', trans('lord::app.customers.account.downloadable-products.download-error'));

            return redirect()->route('lord.customers.account.downloadable_products.index');
        }
