...
use Webkul\Lord\Http\Requests\Customer\AddressRequest;
...
class AddressController extends Controller
{
    ...
    {
        return view('lord::customers.account.addresses.index')->with('addresses', auth()->guard('customer')->user()->addresses);
    }
    ...
    {
        return view('lord::customers.account.addresses.create');
    }
    ...
    public function store(AddressRequest $request)
    {
        ...
        session()->flash('success', trans('lord::app.customers.account.addresses.index.create-success'));

        return redirect()->route('lord.customers.account.addresses.index');
    }
    ...
    public function edit(int $id)
    {
        ...
        return view('lord::customers.account.addresses.edit')->with('address', $address);
    }
    ...
    public function update(int $id, AddressRequest $request)
    {
        ...
        if (! $customer->addresses()->find($id)) {
            session()->flash('warning', trans('lord::app.customers.account.addresses.index.security-warning'));
        ...
        session()->flash('success', trans('lord::app.customers.account.addresses.index.edit-success'));
    ...
    public function makeDefault(int $id)
    {
        ...
        if ($addressToSetDefault) {
            ...
            session()->flash('success', trans('lord::app.customers.account.addresses.index.default-delete'));
        }
    ...
    public function destroy(int $id)
    {
        ...
        session()->flash('success', trans('lord::app.customers.account.addresses.index.delete-success'));
