...
use Webkul\Lord\Http\Requests\ContactRequest;
use Webkul\Lord\Mail\ContactUs;
...
class HomeController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('lord::home.index', compact('customizations'));
    }
    ...
    {
        return view('lord::home.contact-us');
    }
    ...
    public function sendContactUsMail(ContactRequest $contactRequest)
    {
        try {
            ...
            session()->flash('success', trans('lord::app.home.thanks-for-contact'));
        } catch (\Exception $e) {
