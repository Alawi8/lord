...
namespace Webkul\Lord\Mail\Customer\GDPR;
...
class NewRequestNotification extends Mailable
{
    ...
    public function envelope(): Envelope
    {
        $subjectKey = $this->gdprRequest->type === 'update'
            ? 'lord::app.emails.customers.gdpr.new-update-request'
            : 'lord::app.emails.customers.gdpr.new-delete-request';
    ...
    {
        return new Content(
            view: 'lord::emails.customers.gdpr.new-request',
        );
    }
}
