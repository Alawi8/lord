{!! view_render_event('bagisto.lord.categories.view.filters.before') !!}
...
<div v-if="! isMobile">
    ...
    >
        ...
        <x-lord::shimmer.categories.filters />
    </v-filters>
</div>
    ...
    >
        ...
        <x-slot:toggle>
            ...
            >
                ...
                @lang('lord::app.categories.filters.filter')
            </div>
        </x-slot>
        ...
        <x-slot:header>
            <div class="flex items-center justify-between">
                <p class="text-lg font-semibold">
                    @lang('lord::app.categories.filters.filters')
                </p>
                ...
                >
                    @lang('lord::app.categories.filters.clear-all')
                </p>
            </div>
        </x-slot>
    ...
    >
        ...
        <x-slot:toggle>
            ...
            >
                ...
                @lang('lord::app.categories.filters.sort')
            </div>
        </x-slot>
...
{!! view_render_event('bagisto.lord.categories.view.filters.after') !!}
...
@pushOnce('scripts')
    ...
    >
        <x-lord::accordion class="last:border-b-0">
            <!-- Filter Item Header -->
                    ...
                    >
                        <div class="relative">
                            ...
                            <input
                                ...
                                placeholder="@lang('lord::app.categories.filters.search.title')"
                                v-model="searchQuery"
                        ...
                        <p
                            ...
                            v-text="
                                '@lang('lord::app.categories.filters.search.results-info', ['currentCount' => 'currentCount', 'totalCount' => 'totalCount'])'
                    ...
                    <ul class="pb-3 text-base text-gray-700">
                        ...
                        <template v-else>
                            <li
                                ...
                                v-if="! isLoadingMore"
                            >
                                @lang('lord::app.categories.filters.search.no-options-available')
                            </li>
                    ...
                    <div class="flex justify-center pb-3" v-if="meta && meta.current_page < meta.last_page">
                        ...
                        >
                            <span v-if="isLoadingMore">
                                @lang('lord::app.categories.filters.search.loading')
                            </span>

                            <span v-else>
                                @lang('lord::app.categories.filters.search.load-more')
                            </span>
                        </button>
                    </div>
                </template>
    ...
    <script type='module'>
        app.component('v-filters', {
            ...
            methods: {
                getFilters() {
                    this.$axios.get('{{ route("lord.api.categories.attributes") }}', {
                            params: {
        ...
        app.component('v-filter-item', {
            ...
            methods: {
                ...
                fetchFilterOptions(replace = true) {
                    ...
                    const url = `{{ route("lord.api.categories.attribute_options", 'attribute_id') }}`.replace('attribute_id', this.filter.id);
        ...
        app.component('v-price-filter', {
            ...
            methods: {
                getMaxPrice() {
                    this.$axios.get('{{ route("lord.api.categories.max_price", $category->id ?? '') }}')
                        .then((response) => {
                            this.isLoading = false;
