@if ($product->getTypeInstance()->isCustomizable())
    ...
    @if ($options->isNotEmpty())
        {!! view_render_event('bagisto.lord.products.view.customizable-options.before', ['product' => $product]) !!}
        ...
        {!! view_render_event('bagisto.lord.products.view.customizable-options.after', ['product' => $product]) !!}
            ...
            >
                <div class="mt-8 max-sm:mt-0">
                    ...
                    <div class="mb-2.5 mt-5 flex items-center justify-between">
                        <p class="text-sm">
                            @lang('lord::app.products.view.type.simple.customizable-options.total-amount')
                        </p>
            ...
            >
                <div class="mt-8 border-b border-zinc-200 pb-4 max-sm:mt-4 max-sm:pb-0">
                    <x-lord::form.control-group>
                            ...
                            <div class="grid gap-2 max-sm:gap-1">
                                ...
                                >
                                    ...
                                    <label
                                        ...
                                        :for="'customizable_options[' + option.id + '][' + index + ']'"
                                    >
                                        @lang('lord::app.products.view.type.simple.customizable-options.none')
                                    </label>
                                </div>
                        ...
                        <template v-else-if="option.type == 'select'">
                            ...
                            >
                                ...
                                <option
                                    ...
                                    :value="item.id"
                                >
                                    @{{ item.label + ' + ' + $lord.formatPrice(item.price) }}
                                </option>
                            </x-lord::form.control-group.control>
                        </template>
                        ...
                        <x-lord::form.control-group.error ::name="'customizable_options[' + option.id + '][]'" />
                    </x-lord::form.control-group>
                </div>
            </script>
                ...
                app.component('v-product-customizable-options', {
                    ...
                    computed: {
                        formattedTotalPrice: function() {
                            ...
                            return this.$lord.formatPrice(totalPrice);
                        }
                    },
