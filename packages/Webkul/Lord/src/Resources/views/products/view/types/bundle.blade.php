@if ($product->type == 'bundle')
    {!! view_render_event('bagisto.lord.products.view.bundle-options.before', ['product' => $product]) !!}

    <v-product-bundle-options :errors="errors"></v-product-bundle-options>

    {!! view_render_event('bagisto.lord.products.view.bundle-options.after', ['product' => $product]) !!}
        ...
        >
            <div class="mt-8 max-sm:mt-0">
                ...
                <div class="mb-2.5 mt-5 flex items-center justify-between">
                    <p class="text-sm">
                        @lang('lord::app.products.view.type.bundle.total-amount')
                    </p>
                ...
                <x-lord::form.control-group>
                    ...
                    <template v-if="option.type == 'select'">
                        ...
                        >
                            ...
                            >
                                @lang('lord::app.products.view.type.bundle.none')
                            </option>
                    ...
                    <x-lord::form.control-group.error ::name="'bundle_options[' + option.id + '][]'" />
                </x-lord::form.control-group>
            ...
            app.component('v-product-bundle-options', {
                ...
                computed: {
                    formattedTotalPrice: function() {
                        ...
                        return this.$lord.formatPrice(total);
                    }
                },
