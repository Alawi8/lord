@if (Webkul\Product\Helpers\ProductType::hasVariants($product->type))
    {!! view_render_event('bagisto.lord.products.view.configurable-options.before', ['product' => $product]) !!}

    <v-product-configurable-options :errors="errors"></v-product-configurable-options>

    {!! view_render_event('bagisto.lord.products.view.configurable-options.after', ['product' => $product]) !!}
                ...
                >
                    ...
                    <template v-else>
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            >
                                @lang('lord::app.products.view.type.configurable.select-above-options')
                            </span>
                        </div>
                    </template>
            ...
            app.component('v-product-configurable-options', {
                ...
                methods: {
                    ...
                    fillAttributeOptions(attribute) {
                        ...
                        attribute.options = [{
                            'id': '',
                            'label': "@lang('lord::app.products.view.type.configurable.select-options')",
                            'products': []
                        }];
