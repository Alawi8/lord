...
@pushOnce('scripts')
    ...
    <script type="module">
        app.component('v-modal-confirm', {
            ...
            methods: {
                open({
                    title = "@lang('lord::app.components.modal.confirm.title')",
                    message = "@lang('lord::app.components.modal.confirm.message')",
                    options = {
                        btnDisagree: "@lang('lord::app.components.modal.confirm.disagree-btn')",
                        btnAgree: "@lang('lord::app.components.modal.confirm.agree-btn')",
                    },
                    agree = () => {},
                    disagree = () => {},
                }) {
