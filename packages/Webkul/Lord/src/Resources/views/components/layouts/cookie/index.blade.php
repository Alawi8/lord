{!! view_render_event('bagisto.lord.settings.gdpr.modal.before') !!}
...
@pushOnce('scripts')
    ...
    >
        {!! view_render_event('bagisto.lord.settings.gdpr.modal.cookie.before') !!}
                ...
                >
                    ...
                    <div class="cookieDesc cookie-consent__message">
                        <p class="mt-2.5 block font-sans text-sm leading-5 text-white">
                            ...
                            >
                                @lang('lord::app.components.layouts.cookie.index.privacy-policy')
                            </a>
                        </p>
                    </div>
                    ...
                    <div class="cookieButton">
                        <div class="mt-2.5 flex gap-2">
                            <a 
                                ...
                                @click="createCookie()"
                            >
                                @lang('lord::app.components.layouts.cookie.index.accept')
                            </a>
                            ...
                            <a 
                                ...
                                @click="rejectCookie()"
                            >
                                @lang('lord::app.components.layouts.cookie.index.reject')
                            </a>
                        ...
                        <a 
                            ...
                            href="{{ route('lord.customers.gdpr.cookie-consent') }}"
                        >
                            @lang('lord::app.components.layouts.cookie.index.learn-more-and-customize')
                        </a>
                    </div>
                </div>
            @endif
