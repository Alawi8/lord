<x-lord::layouts>
    <!-- Page Title -->
    <x-slot:title>
        @lang('lord::app.components.layouts.cookie.consent.your-cookie-consent-preferences')
    </x-slot>

    {!! view_render_event('bagisto.lord.settings.gdpr.consent.before') !!}

    <v-cookie-consent ref="cookie-consent"></v-cookie-consent>

    {!! view_render_event('bagisto.lord.settings.gdpr.consent.after') !!}
    ...
    @pushOnce('scripts')
        ...
        >
            {!! view_render_event('bagisto.lord.settings.gdpr.consent.form.before') !!}
            ...
            <div class="container mt-8 max-1180:px-5 max-md:mt-6 max-md:px-4">
                <div class="m-auto w-full max-w-[870px] rounded-xl border border-zinc-200 p-16 px-[90px] max-md:px-8 max-md:py-8 max-sm:border-none max-sm:p-0">
                    ...
                    <div class="flex items-center justify-between gap-4 max-sm:flex-wrap">
                        ...
                        >
                            @lang('lord::app.components.layouts.cookie.consent.save-and-continue')
                        </button>
                    </div>
                    ...
                    <div class="mt-14 rounded max-sm:mt-8">
                        ...
                        <!-- Strictly Necessary -->
                        <x-lord::form.control-group class="mb-4 border-b pb-4">
                            <x-lord::form.control-group.label class="font-semibold">
                                @lang('lord::app.components.layouts.cookie.consent.strictly-necessary')
                        ...
                        @foreach ($cookieConsentKeys as $key => $label)
                            <x-lord::form.control-group class="mb-4 border-b pb-4">
                                <x-lord::form.control-group.label class="font-semibold">
                                    @lang('lord::app.components.layouts.cookie.consent.' . $label)
                                </x-lord::form.control-group.label>
            ...
            {!! view_render_event('bagisto.lord.settings.gdpr.consent.form.after') !!}
        </script>
            ...
            app.component('v-cookie-consent', {
                ...
                methods: {
                    ...
                    saveCookiePreferences() {
                        ...
                        window.location.href = '{{ route('lord.home.index') }}';
                    },
