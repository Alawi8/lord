{!! view_render_event('bagisto.lord.components.layouts.header.desktop.top.before') !!}
...
{!! view_render_event('bagisto.lord.components.layouts.header.desktop.top.after') !!}
...
@pushOnce('scripts')
    ...
    >
        <div class="flex w-full items-center justify-between border border-b border-l-0 border-r-0 border-t-0 px-16">
            {!! view_render_event('bagisto.lord.components.layouts.header.desktop.top.currency_switcher.before') !!}

            <!-- Currency Switcher -->
            <x-lord::dropdown position="bottom-{{ core()->getCurrentLocale()->direction === 'ltr' ? 'left' : 'right' }}">
                <!-- Dropdown Toggler -->
                <x-slot:toggle>
                    <div
            ...
            {!! view_render_event('bagisto.lord.components.layouts.header.desktop.top.currency_switcher.after') !!}
            ...
            {!! view_render_event('bagisto.lord.components.layouts.header.desktop.top.locale_switcher.before') !!}
                ...
                <x-slot:toggle>
                    ...
                    >
                        <img
                            ...
                            class="h-full"
                            alt="@lang('lord::app.components.layouts.header.desktop.top.default-locale')"
                            width="24"
                            height="16"
                        />
            ...
            {!! view_render_event('bagisto.lord.components.layouts.header.desktop.top.locale_switcher.after') !!}
        </div>
    </script>
