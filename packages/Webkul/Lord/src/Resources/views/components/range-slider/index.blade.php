        ...
        <div>
            <div class="flex items-center gap-4">
                <p class="text-base max-sm:text-sm">
                    @lang('lord::app.components.range-slider.range')
                </p>
                ...
                <div class="relative h-1 w-full rounded-2xl bg-gray-200">
                    ...
                    <span>
                        <input
                            ...
                            :min="allowedMinRange"
                            :max="allowedMaxRange"
                            aria-label="@lang('lord::app.components.range-slider.min-range')"
                            @input="handle('min')"
                            @change="change"
                        >
                    </span>
                    ...
                    <span>
                        <input
                            ...
                            :min="allowedMinRange"
                            :max="allowedMaxRange"
                            aria-label="@lang('lord::app.components.range-slider.max-range')"
                            @input="handle('max')"
                            @change="change"
                        >
                    </span>
                     ...
                     */
                     if (this.isTypeSupported()) {
                        switch (this.defaultType) {
                            case 'price':
                                return {
                                    formattedAllowedMinRange: this.$lord.formatPrice(this.allowedMinRange),
                                    formattedAllowedMaxRange: this.$lord.formatPrice(this.allowedMaxRange),
                                    formattedMinRange: this.$lord.formatPrice(this.minRange),
                                    formattedMaxRange: this.$lord.formatPrice(this.maxRange),
                                };
