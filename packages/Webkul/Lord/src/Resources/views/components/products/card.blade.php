    ...
    >
        ...
        >
            <div class="relative max-h-[300px] max-w-[291px] overflow-hidden max-md:max-h-60 max-md:max-w-full max-md:rounded-lg max-sm:max-h-[200px] max-sm:max-w-full">
                {!! view_render_event('bagisto.lord.components.products.card.image.before') !!}

                <!-- Product Image -->
                <a
                    :href="`{{ route('lord.product_or_category.index', '') }}/${product.url_key}`"
                ...
                {!! view_render_event('bagisto.lord.components.products.card.image.after') !!}
                
                <!-- Product Ratings -->
                {!! view_render_event('bagisto.lord.components.products.card.average_ratings.before') !!}
                ...
                {!! view_render_event('bagisto.lord.components.products.card.average_ratings.after') !!}
                ...
                <div class="action-items bg-black">
                    ...
                    >
                        @lang('lord::app.components.products.card.sale')
                    </p>
                    ...
                    >
                        @lang('lord::app.components.products.card.new')
                    </p>
                    ...
                    <div class="opacity-0 transition-all duration-300 group-hover:bottom-0 group-hover:opacity-100 max-lg:opacity-100 max-sm:opacity-100">
                        ...
                        {!! view_render_event('bagisto.lord.components.products.card.wishlist_option.before') !!}
                        ...
                        @if (core()->getConfigData('customer.settings.wishlist.wishlist_option'))
                            <span
                                ...
                                role="button"
                                aria-label="@lang('lord::app.components.products.card.add-to-wishlist')"
                                tabindex="0"
                        ...
                        {!! view_render_event('bagisto.lord.components.products.card.wishlist_option.after') !!}

                        {!! view_render_event('bagisto.lord.components.products.card.compare_option.before') !!}
                        ...
                        @if (core()->getConfigData('catalog.products.settings.compare_option'))
                            <span
                                ...
                                role="button"
                                aria-label="@lang('lord::app.components.products.card.add-to-compare')"
                                tabindex="0"
                        ...
                        {!! view_render_event('bagisto.lord.components.products.card.compare_option.after') !!}
            ...
            <div class="-mt-9 grid max-w-[291px] translate-y-9 content-start gap-2.5 bg-white p-2.5 transition-transform duration-300 ease-out group-hover:-translate-y-0 group-hover:rounded-t-lg max-md:relative max-md:mt-0 max-md:translate-y-0 max-md:gap-0 max-md:px-0 max-md:py-1.5 max-sm:min-w-[170px] max-sm:max-w-[192px] shadow-sm border-spacing-1">

                {!! view_render_event('bagisto.lord.components.products.card.name.before') !!}
                ...
                {!! view_render_event('bagisto.lord.components.products.card.name.after') !!}

                <!-- Pricing -->
                {!! view_render_event('bagisto.lord.components.products.card.price.before') !!}
                ...
                {!! view_render_event('bagisto.lord.components.products.card.price.after') !!}
                ...
                <div class="action-items flex items-center justify-between opacity-0 transition-all duration-300 ease-in-out group-hover:opacity-100 max-md:hidden">
                    @if (core()->getConfigData('sales.checkout.lordping_cart.cart_page'))
                        {!! view_render_event('bagisto.lord.components.products.card.add_to_cart.before') !!}
                        ...
                        <button
                            ...
                            @click="addToCart()"
                        >
                            @lang('lord::app.components.products.card.add-to-cart')
                        </button>

                        {!! view_render_event('bagisto.lord.components.products.card.add_to_cart.after') !!}
                    @endif
        ...
        >
            <div class="group relative max-h-[258px] max-w-[250px] overflow-hidden"> 
                ...
                <a :href="`{{ route('lord.product_or_category.index', '') }}/${product.url_key}`">
                    <x-lord::media.images.lazy
            ...
            <div class="grid content-start gap-4">
                ...
                <p class="text-sm text-zinc-500">
                    <template  v-if="! product.ratings.total">
                        <p class="text-sm text-zinc-500">
                            @lang('lord::app.components.products.card.review-description')
                        </p>
                    </template>
                ...
                @if (core()->getConfigData('sales.checkout.lordping_cart.cart_page'))
                    ...
                    <x-lord::button
                        ...
                        :title="trans('lord::app.components.products.card.add-to-cart')"
        ...
        app.component('v-product-card', {
            ...
            methods: {
                ...
                addToCompare(productId) {
                    ...
                    if (items.length) {
                        if (! items.includes(productId)) {
                            ...
                            this.$emitter.emit('add-flash', { type: 'success', message: "@lang('lord::app.components.products.card.add-to-compare-success')" });
                        } else {
                            this.$emitter.emit('add-flash', { type: 'warning', message: "@lang('lord::app.components.products.card.already-in-compare')" });
                        }
                    } else {
                ...
                addToCart() {
                    ...
                    this.$axios.post('{{ route("lord.api.checkout.cart.store") }}', {
                            'quantity': 1,
                            'product_id': this.product.id,
                        })
                        .then(response => {
