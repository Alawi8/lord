<x-lord::layouts.account>
    <!-- Page Title -->
    <x-slot:title>
        @lang('lord::app.customers.account.orders.title')
    </x-slot>

    <!-- Breadcrumbs -->
    @if ((core()->getConfigData('general.general.breadcrumbs.lord')))
        @section('breadcrumbs')
            <x-lord::breadcrumbs name="orders" />
        @endSection
    @endif
    ...
    <div class="mx-4 flex-auto max-md:mx-6 max-sm:mx-4">
        ...
        {!! view_render_event('bagisto.lord.customers.account.orders.list.before') !!}

        <!-- For Desktop View -->
        <div class="max-md:hidden">
            <x-lord::datagrid :src="route('lord.customers.account.orders.index')" />
        </div>
                                ...
                                <a :href="record.actions[0].url">
                                    <div class="flex justify-between">
                                        <div class="text-sm font-semibold">
                                            @lang('lord::app.customers.account.orders.order-id'): #@{{ record.id }}
                                    ...
                                    <div class="mt-2.5 text-xs font-normal text-neutral-500">
                                        @lang('lord::app.customers.account.orders.subtotal')
        ...
        {!! view_render_event('bagisto.lord.customers.account.orders.list.after') !!}
