...
>
    ...
    <x-lord::shimmer.checkout.onepage.shipping-method />
</v-shipping-methods>
                    ...
                    <x-slot:header class="px-0 py-4 max-md:p-3 max-md:text-sm max-md:font-medium max-sm:p-2">
                        <div class="flex items-center justify-between">
                            <h2 class="text-2xl font-medium max-md:text-base">
                                @lang('lord::app.checkout.onepage.shipping.shipping-method')
                            </h2>
                        </div>
                    </x-slot>
        ...
        app.component('v-shipping-methods', {
            ...
            methods: {
                store(selectedMethod) {
                    ...
                    this.$axios.post("{{ route('lord.checkout.onepage.shipping_methods.store') }}", {    
