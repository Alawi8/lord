{!! view_render_event('bagisto.lord.checkout.onepage.address.guest.before') !!}
...
{!! view_render_event('bagisto.lord.checkout.onepage.address.guest.after') !!}

@include('lord::checkout.onepage.address.form')
    ...
    >
        ...
        >
            <form @submit="handleSubmit($event, addAddress)">
                ...
                <div class="mb-4">
                    {!! view_render_event('bagisto.lord.checkout.onepage.address.guest.billing.before') !!}
                    ...
                    {!! view_render_event('bagisto.lord.checkout.onepage.address.guest.billing.after') !!}
                </div>
                ...
                <template v-if="cart.have_stockable_items">
                    ...
                    >
                        {!! view_render_event('bagisto.lord.checkout.onepage.address.guest.shipping.before') !!}
                        ...
                        {!! view_render_event('bagisto.lord.checkout.onepage.address.guest.shipping.after') !!}
                    </div>
                </template>
        ...
        app.component('v-checkout-address-guest', {
            ...
            methods: {
                addAddress(params, { setErrors }) {
                    ...
                    this.$axios.post('{{ route('lord.checkout.onepage.addresses.store') }}', params)
                        .then((response) => {
