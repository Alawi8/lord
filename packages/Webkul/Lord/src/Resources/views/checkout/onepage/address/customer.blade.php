{!! view_render_event('bagisto.lord.checkout.onepage.address.customer.before') !!}
...
>
    ...
    <x-lord::shimmer.checkout.onepage.address />
</v-checkout-address-customer>

{!! view_render_event('bagisto.lord.checkout.onepage.address.customer.after') !!}
                    ...
                    <form @submit="handleSubmit($event, addAddressToCart)">
                        ...
                        <div class="mb-4 flex items-center justify-between max-md:mb-2">
                            <h2 class="text-xl font-medium max-sm:text-base max-sm:font-normal">
                                @lang('lord::app.checkout.onepage.address.billing-address')
                            </h2>
                        </div>
                        ...
                        <div class="mb-2 grid grid-cols-2 gap-5 max-1060:grid-cols-[1fr] max-lg:grid-cols-2 max-md:mt-2 max-md:grid-cols-1">
                            ...
                            >
                                ...
                                <div class="absolute top-5 flex gap-2 ltr:right-5 rtl:left-5">
                                    <x-lord::form.control-group class="!mb-0 flex items-center gap-2.5">
                                        <x-lord::form.control-group.control
                                            ...
                                            rules="required"
                                            label="{{ trans('lord::app.checkout.onepage.address.billing-address') }}"
                                        />
                            ...
                            >
                                ...
                                >
                                    ...
                                    <p class="text-base">@lang('lord::app.checkout.onepage.address.add-new-address')</p>
                                </div>
                            </div>
                        </div>

                        <!-- Error Message Block -->
                        <x-lord::form.control-group.error name="billing.id" />

                        <!-- Shipping Address Block if have stockable items -->
                        <template v-if="cart.have_stockable_items">
                            <!-- Use for Shipping Checkbox -->
                            <x-lord::form.control-group class="!mb-0 mt-5 flex items-center gap-2.5">
                                <x-lord::form.control-group.control
                                    type="checkbox"
                                ...
                                <label
                                    ...
                                    for="use_for_shipping"
                                >
                                    @lang('lord::app.checkout.onepage.address.same-as-billing')
                                </label>
                            </x-lord::form.control-group>
                            ...
                            >
                                ...
                                <div class="mb-4 flex items-center justify-between">
                                    <h2 class="text-xl font-medium max-md:text-lg max-sm:text-base">
                                        @lang('lord::app.checkout.onepage.address.shipping-address')
                                    </h2>
                                </div>
                                        ...
                                        <div class="absolute top-5 flex gap-5 ltr:right-5 rtl:left-5">
                                            <x-lord::form.control-group class="!mb-0 flex items-center gap-2.5">
                                                <x-lord::form.control-group.control
                                                    ...
                                                    rules="required"
                                                    label="{{ trans('lord::app.checkout.onepage.address.shipping-address') }}"
                                                />
                                            </x-lord::form.control-group>
                                ...
                                <x-lord::form.control-group.error name="shipping.id" />
                            </div>
                        </template>
                        ...
                        <div class="mt-4 flex justify-end max-md:my-4">
                            <x-lord::button
                                ...
                                :title="trans('lord::app.checkout.onepage.address.proceed')"
                                ::loading="isStoring"
                                ::disabled="isStoring"
                            />
                        </div>
                    ...
                    <form @submit="handleSubmit($event, updateOrCreateAddress)">
                        ...
                        <div class="mb-4 flex items-center justify-between">
                            ...
                            >
                                ...
                                @lang('lord::app.checkout.onepage.address.back')
                            </span>
                        </div>
                        ...
                        <x-lord::form.control-group class="!mb-0 flex items-center gap-2.5">
                            ...
                            <label
                                ...
                                for="save_address"
                            >
                                @lang('lord::app.checkout.onepage.address.save-address')
                            </label>
                        </x-lord::form.control-group>
                        ...
                        <div class="mt-4 flex justify-end">
                            <x-lord::button
                                class="primary-button rounded-2xl px-11 py-3 max-md:rounded-lg max-sm:w-full max-sm:max-w-full max-sm:py-1.5"
                                :title="trans('lord::app.checkout.onepage.address.save')"
                                ::loading="isStoring"
                                ::disabled="isStoring"
                            />
                        </div>
        ...
        app.component('v-checkout-address-customer', {
            ...
            methods: {
                getCustomerSavedAddresses() {
                    this.$axios.get('{{ route('lord.api.customers.account.addresses.index') }}')
                        .then(response => {
                ...
                createCustomerAddress(params, { setErrors }) {
                    ...
                    return this.$axios.post('{{ route('lord.api.customers.account.addresses.store') }}', params)
                        .then((response) => {
                ...
                updateCustomerAddress(id, params, { setErrors }) {
                    ...
                    return this.$axios.put('{{ route('lord.api.customers.account.addresses.update') }}/' + id, params)
                        .then((response) => {
                            this.isStoring = false;
                ...
                addAddressToCart(params, { setErrors }) {
                    ...
                    this.$axios.post('{{ route('lord.checkout.onepage.addresses.store') }}', payload)
                        .then((response) => {
                            this.isStoring = false;
