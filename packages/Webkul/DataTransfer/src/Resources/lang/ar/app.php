...
return [
        ...
        'products' => [
            ...
            'validation' => [
                'errors' => [
                    ...
                    'invalid-attribute-family'  => 'قيمة غير صالحة لعمود مجموعة الحقول (مجموعة الحقول غير موجودة؟)',
                    'invalid-type'              => 'نوع المنتج غير صالح أو غير مدعوم',
                    'sku-not-found'             => 'المنتج بالرمز SKU المحدد غير موجود',
                    'super-attribute-not-found' => 'لم يتم العثور على السمة الفائقة بالرمز: \'%s\' أو لا تنتمي إلى عائلة الحقول: \'%s\'',
                ],
            ],
        ],
    ...
    'validation' => [
        'errors' => [
            ...
            'invalid-attribute'    => 'الرأس يحتوي على حقول غير صالحة: "%s".',
